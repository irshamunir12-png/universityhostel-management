...
// Auto-Fix: Add 'category_id' column to complaints table if it doesn't exist.
// This is a self-healing mechanism to prevent fatal errors if a migration was missed.
try {
    $pdo->query("SELECT category_id FROM complaints LIMIT 1");
} catch (Exception $e) {
    $pdo->exec("ALTER TABLE complaints ADD COLUMN category_id INT DEFAULT NULL AFTER user_id;");
}
